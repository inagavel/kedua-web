  ...
  return (
    <section className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1497486751825-1233686d5d80?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=6000&q=80')`
        }}
      />
      
      {/* Overlay with lighter gradient for better visibility */}
      <div className="absolute inset-0 bg-gradient-to-br from-white/80 via-education-light-blue/70 to-education-light-green/70" />
